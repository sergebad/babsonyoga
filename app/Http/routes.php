...
// Babson Yoga: Facebook Login
Route::get('/login/redirect', 'SocialAuthController@redirect');
Route::get('/login/callback', 'SocialAuthController@callback');
Route::get('/privacypolicy', 'SocialAuthController@privacy');

// Babson Yoga: Facebook Messenger
Route::any('/messenger/update', ['middleware' => 'api', 'uses' => 'FBMessengerController@update']);
Route::any('/messenger/notify', ['middleware' => 'api', 'uses' => 'FBMessengerController@notify']);
